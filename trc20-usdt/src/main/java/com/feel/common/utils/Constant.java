...
public class Constant {
    ...
    public static String tronUrl = mainNetUrl;
...
//    public  static String contract = "TAozjQdXvMrBWZLUDZCvQVqNBmZ1jfWYny";

    //主网？
    public  static String contract = "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t";
